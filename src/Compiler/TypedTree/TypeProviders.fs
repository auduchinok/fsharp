...
type ProvidedType (x: Type, ctxt: ProvidedTypeContext) =
    ...
    default _.Namespace : string MaybeNull = x.Namespace
    ...
    default _.Assembly: ProvidedAssembly MaybeNull = x.Assembly |> ProvidedAssembly.Create
    ...
    default _.GetStaticParameters(provider: ITypeProvider) : ProvidedParameterInfo[] MaybeNull = provider.GetStaticParameters x |> ProvidedParameterInfo.CreateArray ctxt
...
type ProvidedMethodBase (x: MethodBase, ctxt) = 
    ...
    default _.GetStaticParametersForMethod(provider: ITypeProvider) : ProvidedParameterInfo[] = 
...
#if NO_CHECKNULLS
[<RequireQualifiedAccess; Class; AllowNullLiteral>]
#else
...
type ProvidedExpr (x: Expr, ctxt) =
    ...
    default _.Type = x.Type |> ProvidedType.Create ctxt
    ...
    default _.UnderlyingExpressionString = x.ToString()
