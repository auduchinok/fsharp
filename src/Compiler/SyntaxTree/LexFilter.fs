...
type LexFilterImpl (
    ...
    let rec hwTokenFetch useBlockRule =
        ...
        | ((TokenRExprParen | INTERP_STRING_END _ | INTERP_STRING_PART _) as t2), (CtxtParen (t1, _) :: _)
            ...
            | INTERP_STRING_PART _ ->
                ...
                pushCtxtSeqBlockStrict tokenTup NoAddBlockEnd
            | _ ->
        ...
        | _, CtxtModuleHead (moduleTokenPos, prevToken, lexingModuleAttributes) :: rest ->
            ...
            | _, (EQUALS | COLON) ->
                ...
                pushCtxtSeqBlockStrict tokenTup AddBlockEnd
                returnToken tokenLexbufState token
            | _ ->
                match rest with
                | [ CtxtSeqBlock _ ] ->
                    ...
                    | _ ->
                        ...
                        pushCtxtSeqBlockAt false tokenTup tokenTup AddBlockEnd // todo: check this
                        hwTokenFetch false
                | _ ->
        ...
        | (TokenLExprParen | SIG | INTERP_STRING_BEGIN_PART _), _ ->
            ...
            pushCtxtSeqBlock NoAddBlockEnd
            returnToken tokenLexbufState token
        ...
        | RARROW, ctxts
            ...
            pushCtxtSeqBlockStrict tokenTup AddOneSidedBlockEnd
            returnToken tokenLexbufState token
        ...
        | INTERFACE, _ ->
            ...
            | DEFAULT | OVERRIDE | INTERFACE | NEW | STATIC | END | MEMBER | ABSTRACT | INHERIT | LBRACK_LESS ->
    ...
    and pushCtxtSeqBlock addBlockEnd =
        let tokenTup = peekNextTokenTup()
        pushCtxtSeqBlockAt false tokenTup tokenTup addBlockEnd

    and pushCtxtSeqBlockStrict fallbackToken addBlockEnd =
        pushCtxtSeqBlockAt true fallbackToken (peekNextTokenTup()) addBlockEnd
